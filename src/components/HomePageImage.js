            ...
            <div className="w-screen z-10 h-[85vh]">
                <div className="w-[60vw] h-[85vh] bg-gradient-to-r from-[#000] via-[#000] to-transparent pl-20 flex items-center">
                    <div className="w-[600px]">
                        <h1 className="text-6xl font-semibold  uppercase text-white my-text-shadow pb-2">{movieName}</h1>
                        <div>
                            <div className="flex flex-row items-center gap-x-4 my-2 font-semibold">
                                {movieRating !== 0 && (
                        ...
                        <p className="text-gray-100 my-text-shadow py-2 font-semibold text-justify">{movieOverView}</p>

                        <div className="py-2 flex mt-auto gap-x-5">
                            <button className="button play flex justify-center items-center bg-gray-200 hover:bg-gray-300 transition-all px-6 py-2 rounded font-semibold text-black">
                                <span className="text-lg mr-3">&#9654;</span>PLAY NOW
                            </button>
                            <button className="button add flex justify-center items-center bg-gray-700 hover:bg-gray-800 bg-opacity-80 hover:bg-opacity-80 transition-all px-6 py-2 rounded font-semibold text-white">
                                <span className="text-4xl mr-3">&#43;</span>WATCHLIST
                            </button>
                        </div>
                    </div>
                </div>
