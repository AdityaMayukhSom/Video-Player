        ...
        <div className="flex h-full w-full justify-center">
            <div className="cursor-pointer liked-video glasomorphism h-52 w-full lg:max-w-[75%] rounded-lg grid grid-cols-[2fr_3fr] grid-rows-1 my-2 gap-x-4 p-3 mx-6">
                ...
                <div className="h-full w-full ">
                    <img className="w-full h-full object-cover rounded-md" src={props.movieImage} alt=""></img>
                </div>
                <div className="pr-2">
                    ...
                    <div className="no-scrollbar overflow-y-auto h-[92px] my-1 text-white text-md text-justify">{movieDetails}</div>
                    <div className="mt-4">
